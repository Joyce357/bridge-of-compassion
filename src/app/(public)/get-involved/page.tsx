  ...
  return (
    <>
      ...
      <section className="bg-brand-navy-dark section-py text-brand-warm-white relative overflow-hidden">
        <div
          className="absolute -top-24 -right-24 w-96 h-96 bg-brand-cyan/15 rounded-full blur-3xl"
          aria-hidden="true"
        />
        <div
          className="absolute -bottom-24 -left-24 w-96 h-96 bg-brand-green/20 rounded-full blur-3xl"
          aria-hidden="true"
        />
      ...
      <section className="section-py bg-brand-warm-white">
        <Container>
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-brand-navy tracking-tight mb-3">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8 items-stretch">
            ...
            {/* Pathway 1: Volunteer */}
            <div className="card flex flex-col p-6 sm:p-7 justify-between border-border-soft hover:border-brand-green/40">
              <div>
                <div className="w-12 h-12 rounded-xl bg-brand-sage/40 text-brand-green flex items-center justify-center text-2xl mb-4 shadow-2xs">
                  🤝
                </div>
                <h3 className="text-xl font-bold text-brand-navy mb-2">Volunteer With Us</h3>
            ...
            {/* Pathway 2: Donate */}
            <div className="card flex flex-col p-6 sm:p-7 justify-between border-border-soft hover:border-accent-pink/40">
              <div>
                <div className="w-12 h-12 rounded-xl bg-pink-50 text-accent-pink flex items-center justify-center text-2xl mb-4 shadow-2xs">
                  💚
                </div>
                <h3 className="text-xl font-bold text-brand-navy mb-2">Make a Donation</h3>
                <p className="text-text-secondary text-xs sm:text-sm leading-relaxed mb-6">
            ...
            <div id="partner" className="card flex flex-col p-6 sm:p-7 justify-between border-border-soft hover:border-brand-cyan/40 scroll-mt-24">
              <div>
                <div className="w-12 h-12 rounded-xl bg-brand-sky text-brand-cyan flex items-center justify-center text-2xl mb-4 shadow-2xs">
                  🌿
                </div>
                <h3 className="text-xl font-bold text-brand-navy mb-2">Partner With Us</h3>
                <p className="text-text-secondary text-xs sm:text-sm leading-relaxed mb-6">
      ...
      <section className="section-py bg-brand-cream border-t border-border-soft/60">
        <Container>
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              {[
                ...
                <div
                  key={item.title}
                  className="flex items-start gap-4 bg-brand-warm-white rounded-2xl p-4 sm:p-5 border border-border-soft shadow-2xs"
                >
                  <div className="w-10 h-10 rounded-xl bg-brand-sage/40 flex items-center justify-center text-xl shrink-0">
                    {item.icon}
                  </div>
                  <div>
      ...
      <section className="section-py-sm bg-brand-sky/40 border-t border-brand-sky/70">
        <Container>
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
            <div>
              <h3 className="text-base sm:text-lg font-bold text-brand-navy mb-0.5">
