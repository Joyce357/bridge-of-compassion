...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="space-y-8 max-w-2xl">
      <div>
        <h1 className="text-2xl font-extrabold text-brand-navy tracking-tight">Admin Settings</h1>
        <p className="text-sm text-text-secondary mt-0.5">Manage your account profile, profile picture, and security</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-border-soft shadow-xs p-6 sm:p-7">
        <div className="flex items-center justify-between border-b border-border-soft/60 pb-4 mb-6">
          <div>
            ...
            <p className="text-xs text-text-secondary mt-0.5">Profile photo and basic account details</p>
          </div>
