  ...
  return (
    <section className="section-py bg-brand-warm-white" aria-labelledby="stories-heading">
      <Container>
        ...
        {featured.length === 0 ? (
          <div className="text-center py-12 px-6 bg-white rounded-3xl border border-border-soft shadow-xs max-w-xl mx-auto">
            <div className="w-12 h-12 rounded-xl bg-brand-sage/40 flex items-center justify-center text-2xl mx-auto mb-3">
              📰
            </div>
            <h3 className="text-base font-bold text-brand-navy mb-1.5">New Stories Coming Soon</h3>
            ...
            {featured.map((story) => {
              ...
              return (
                <Link
                  ...
                  className="group card flex flex-col focus-visible:ring-2 focus-visible:ring-brand-navy bg-white border border-border-soft hover:border-brand-green/40 hover:shadow-card-hover rounded-2xl overflow-hidden transition-all duration-200"
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 p-5">
                    ...
                    <h3 className="text-brand-navy text-base font-bold leading-snug mb-2 group-hover:text-brand-green transition-colors duration-200 line-clamp-2">
                      {story.title}
                    </h3>
                    ...
                    <div className="flex items-center gap-1.5 text-brand-green text-xs sm:text-sm font-bold group-hover:text-brand-navy transition-colors duration-200 mt-auto pt-1">
